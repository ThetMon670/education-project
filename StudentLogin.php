  ...
  if (isset($_POST['btnlogin'])) 
{
    ...
    $checkaccount="SELECT * FROM studenttb WHERE Email='$Email' AND Password='$Password'";
...
<head>
  ...
  <title>MMS IT/StudentLoginForm</title>
...
<body>
    ...
    <div class="flex flex-col justify-center font-[sans-serif] p-32" id="app">
            <div class="max-w-md w-full mx-auto border border-gray-300 rounded-2xl p-8">
              <form class="space-y-6" action="StudentLogin.php" method="POST" enctype="multipart/form-data">
                    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
                      <img class="mx-auto h-10 w-auto" src="https://mms-it.com/profile/images/logo.png" >
                      <h2 class="mt-5 mb-5 text-center text-2xl/9 font-bold tracking-tight text-black-700">Student Login Form</h2>
                    </div>
                    <div>
